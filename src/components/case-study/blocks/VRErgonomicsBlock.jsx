      ...
      <div className="max-w-[1200px] mx-auto flex flex-col gap-8 md:gap-12">
        ...
        <div className="flex flex-col gap-8 md:gap-12">
          <SectionHeader 
            ...
            heading="Designing information around the task, not over it"
            description="In a VR traffic simulation, the interface cannot compete with the intersection itself. I structured the information architecture around where the user looks, what they are doing, and how much guidance they need at each stage of training."
            className="!mb-0"
          />
        ...
        <div className="flex flex-col gap-8 md:gap-12">
          <SectionHeader 
            heading="The UI stays within the user's natural view"
            className="!mb-0"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/5 border border-white/10 p-6 md:p-8 lg:p-10 rounded-[2rem] flex flex-col gap-4 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all duration-500">
              ...
              <h4 className="font-clash text-[20px] md:text-[22px] font-medium text-white/90">110&deg; Field of View</h4>
            ...
            <div className="bg-white/5 border border-white/10 p-6 md:p-8 lg:p-10 rounded-[2rem] flex flex-col gap-4 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all duration-500">
              ...
              <h4 className="font-clash text-[20px] md:text-[22px] font-medium text-white/90">Spatial Legibility</h4>
              <p className="font-clash text-sm md:text-[15px] font-medium tracking-wide text-white/60 leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/10 p-6 md:p-8 lg:p-10 rounded-[2rem] flex flex-col gap-4 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all duration-500">
              ...
              <h4 className="font-clash text-[20px] md:text-[22px] font-medium text-white/90">Comfortable Depth</h4>
              <p className="font-clash text-sm md:text-[15px] font-medium tracking-wide text-white/60 leading-relaxed">
        ...
        <div className="flex flex-col gap-8 md:gap-12 relative">
          ...
          <SectionHeader 
            heading="Two layers of information, two modes of attention"
        ...
        <div className="flex flex-col gap-8 md:gap-12">
          <SectionHeader 
            heading="Teach the gesture. Then remove the guidance."
            description="The training interface gradually reduces support: users first learn through visual and audio cues, then perform the same actions independently in live traffic."
            className="!mb-0"
          />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 relative">
            ...
            <div className="flex flex-col gap-4 relative z-10 group">
              ...
              <div>
                ...
                <p className="font-clash text-base text-primary font-medium mb-2">Ghost Hands</p>
            ...
            <div className="flex flex-col gap-4 relative z-10 group">
              ...
              <div>
                ...
                <p className="font-clash text-base text-primary font-medium mb-2">Hand Tracking</p>
            ...
            <div className="flex flex-col gap-4 relative z-10 group">
              ...
              <div>
                ...
                <p className="font-clash text-base text-primary font-medium mb-2">Immediate Feedback</p>
            ...
            <div className="flex flex-col gap-4 relative z-10 group">
              ...
              <div>
                ...
                <p className="font-clash text-base text-primary font-medium mb-2">World Feedback</p>
        ...
        <div className="w-full rounded-[2rem] bg-gradient-to-br from-white/5 to-transparent border border-white/10 p-6 md:p-12 lg:p-16 flex flex-col gap-8 md:gap-12 relative overflow-hidden">
          ...
          <div className="text-center relative z-10">
            <h4 className="font-clash text-2xl md:text-3xl font-medium tracking-wide text-white/90 mb-3">Every interaction follows the same loop</h4>
          ...
          <div className="text-center relative z-10 mt-4 max-w-2xl mx-auto">
            ...
            <p className="font-clash text-lg md:text-xl font-medium tracking-wide text-white/80 leading-snug">
